...
import (
	...
	"go-micro.org/v4/auth"
	"go-micro.org/v4/broker"
	"go-micro.org/v4/cache"
	"go-micro.org/v4/client"
	"go-micro.org/v4/config"
	"go-micro.org/v4/debug/profile"
	"go-micro.org/v4/debug/profile/http"
	"go-micro.org/v4/debug/profile/pprof"
	"go-micro.org/v4/debug/trace"
	"go-micro.org/v4/logger"
	"go-micro.org/v4/registry"
	"go-micro.org/v4/runtime"
	"go-micro.org/v4/selector"
	"go-micro.org/v4/server"
